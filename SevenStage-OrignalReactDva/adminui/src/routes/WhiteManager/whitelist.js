...
//         |
//         <Popconfirm title="Are you sure you want to delete this?" onConfirm={() =>handleRemove(record.key)}>
...
class whitelist extends Component {
  ...
  render() {
    return (
      <TableList data={this.props.whiteList.data} dispatch={this.props.dispatch}/>
    );
  }
}
