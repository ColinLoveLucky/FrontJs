...
class Page1Service extends BaseService {
...
angular.module('biz-services').factory("Page1Service", ["UtilsService", "toastr", "LoadingService", function (UtilsService, toastr, LoadingService) {
    return new Page1Service(UtilsService, toastr, LoadingService);
}]);
